1. Request-response - Клиентът изпраща заявка н а сървъра, той го обработва и връща отговор; Stateless, server-client architecture; HTTP е пример за request-response протокол; 
